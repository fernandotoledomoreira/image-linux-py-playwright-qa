...
pipeline {
    ...
    stages {
        ...
        stage('Pre-Build') {
            ...
            steps {
                script {
                    ...
                    env['url_docker'] = "758526784474.dkr.ecr.us-east-1.amazonaws.com/image-linux-py-playwright-qa:${newVersion}"
                }
        ...
        stage ('delete image'){
            ...
            steps{
                script{
                    removeImage('image-linux-py-playwright-qa',env['newVersion'])
                }
            }
        }
...
def notifyBuild(String buildStatus = 'STARTED') {
    ...
    if (buildStatus == 'STARTED') {
        ...
        field.put('value', 'image-linux-py-playwright-qa');
        fields.add(field);
